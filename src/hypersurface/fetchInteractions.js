// fetchHypersurfaceCollateralAssetDeposited.js
import fs from "fs";
...
const OUTPUT_FILE = "hypersurfaceCollateralAssetDepositedLogs.json";
...
// ---- Hypersurface contract ----
const HYPERSURFACE_CONTRACT = "0x7730e6bfbfCE8Ff0b7a50b72D0601c209Eb818C4";
...
async function main() {
  ...
  // Last 1,000,000 blocks; clamp to 0
  const span = 1_000_000n;
  const FROM_BLOCK = 0n;
  const TO_BLOCK = latestBlock;

  console.log(
    `Fetching Hypersurface CollateralAssetDeposited logs from block ${FROM_BLOCK} to ${TO_BLOCK}...`
  );
