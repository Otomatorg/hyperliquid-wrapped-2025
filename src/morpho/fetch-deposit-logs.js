...
// Save Morpho logs here
const OUTPUT_FILE = "morphoSupplyLogs.json";
...
// Supply(indexed bytes32 id, indexed address caller, indexed address onBehalf, uint256 assets, uint256 shares)
const SUPPLY_EVENT = {
  type: "event",
  name: "Supply",
  inputs: [
...
async function main() {
  console.log(
    `Fetching Morpho Supply logs from block ${FROM_BLOCK} to ${TO_BLOCK}...`
  );
