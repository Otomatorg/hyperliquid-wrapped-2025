...
const OUTPUT_FILE = "hybrav4TransferLogs.json";

const FROM_BLOCK = 0n; // scan from genesis; change if you want a smaller window
...
// HyperSwap V3: Non-fungible Token Position Manager
const HYPERSWAP_NFT_POSITION_MANAGER =
  "0xcc9E3991360229Fd13694022b9456D371f1a2568";

// ERC-721 style Transfer(address from, address to, uint256 tokenId)
  ...
  while (true) {
    ...
    try {
      const logs = await client.getLogs({
        address: HYPERSWAP_NFT_POSITION_MANAGER,
...
async function main() {
  ...
  console.log(
    `Fetching HyperSwap Transfer logs from block ${FROM_BLOCK} to ${TO_BLOCK}...`
  );
