...
export const CustomToast: React.FC<CustomToastProps> = ({ message, variant = 'success' }) => {
      ...
      <div className="shrink-0 mt-0.5" aria-hidden>
        {isError ? (
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
            <path d="M12 9v4" stroke="#DC2626" strokeWidth="1.5" strokeLinecap="round" />
            <path d="M12 16.5h.01" stroke="#DC2626" strokeWidth="1.5" strokeLinecap="round" />
            <path
